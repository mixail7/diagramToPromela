...
namespace dataLibrary_Pal {
  ...
  /// </summary>
  public partial class ActionToolBox : UserControl {
    ...
    private void Grid_MouseMove(object sender, MouseEventArgs e) {
      ...
      var dataObject = new DragObject { formatStr = BlockToolBoxPalleter.blockFormatName, data = ActionElement.ElementName };
