...
namespace SkillsTree {
  ...
  /// </summary>
  public partial class TaskToolBox : UserControl {
    public TaskToolBox() {
      InitializeComponent();
    }
    ...
    private void Grid_MouseMove(object sender, MouseEventArgs e) {
      ...
      var dataObject = new DragObject { formatStr = BlockToolBoxPalleter.blockFormatName, data = WorkerElement.ElementName };
      dataObject.DesiredSize = new Size(100, 50);
